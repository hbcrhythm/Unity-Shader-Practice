...
Shader "Cube"
{
	...
	SubShader
	{
		...
		{
			float4 color2 = IsGammaSpace() ? float4(0.3249705,0.490566,0.0532218,0) : float4(0.0862172,0.2054128,0.004232037,0);
			o.Albedo = color2.rgb;
			o.Alpha = 1;
		}
